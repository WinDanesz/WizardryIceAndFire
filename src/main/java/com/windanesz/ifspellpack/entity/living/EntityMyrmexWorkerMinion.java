...
public class EntityMyrmexWorkerMinion extends EntityMyrmexWorker implements ISummonedCreature {

	private static final DataParameter<Boolean> SPAWN_PARTICLES = EntityDataManager.createKey(EntityMyrmexWorkerMinion.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> EXPLOSIVE = EntityDataManager.createKey(EntityMyrmexWorkerMinion.class, DataSerializers.BOOLEAN);

	private int lifetime = -1;
	private UUID casterUUID;

	public EntityMyrmexWorkerMinion(World worldIn) {
		super(worldIn);
