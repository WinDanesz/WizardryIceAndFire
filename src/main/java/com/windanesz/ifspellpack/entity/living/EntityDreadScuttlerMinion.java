...
public class EntityDreadScuttlerMinion extends EntityDreadScuttler implements ISummonedCreature {

	private static final DataParameter<Boolean> SPAWN_PARTICLES = EntityDataManager.createKey(EntityDreadScuttlerMinion.class, DataSerializers.BOOLEAN);

	private int lifetime = -1;
	private UUID casterUUID;

	public EntityDreadScuttlerMinion(World world){
		super(world);
