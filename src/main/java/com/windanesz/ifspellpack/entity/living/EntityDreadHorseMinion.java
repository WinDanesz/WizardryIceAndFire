...
public class EntityDreadHorseMinion extends EntityDreadHorse implements ISummonedCreature {

	private static final DataParameter<Boolean> SPAWN_PARTICLES = EntityDataManager.createKey(EntityDreadHorseMinion.class, DataSerializers.BOOLEAN);
