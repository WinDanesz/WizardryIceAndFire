...
public class EntityMyrmexSentinelMinion extends EntityMyrmexSentinel implements ISummonedCreature {

	private static final DataParameter<Boolean> SPAWN_PARTICLES = EntityDataManager.createKey(EntityMyrmexSentinelMinion.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> EXPLOSIVE = EntityDataManager.createKey(EntityMyrmexSentinelMinion.class, DataSerializers.BOOLEAN);

	private int lifetime = -1;
	private UUID casterUUID;

	public EntityMyrmexSentinelMinion(World worldIn) {
		super(worldIn);
