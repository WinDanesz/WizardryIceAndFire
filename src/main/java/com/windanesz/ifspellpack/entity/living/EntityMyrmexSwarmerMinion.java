...
public class EntityMyrmexSwarmerMinion extends EntityMyrmexSwarmer implements ISummonedCreature {

	private static final DataParameter<Boolean> SPAWN_PARTICLES = EntityDataManager.createKey(EntityMyrmexSwarmerMinion.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> EXPLOSIVE = EntityDataManager.createKey(EntityMyrmexSwarmerMinion.class, DataSerializers.BOOLEAN);

	private int lifetime = -1;
	private UUID casterUUID;

	public EntityMyrmexSwarmerMinion(World worldIn) {
		super(worldIn);
