...
public class EntityDreadThrallMinion extends EntityDreadThrall implements ISummonedCreature {

	private static final DataParameter<Boolean> SPAWN_PARTICLES = EntityDataManager.createKey(EntityDreadThrallMinion.class, DataSerializers.BOOLEAN);

	private int lifetime = -1;
	private UUID casterUUID;
	private boolean equipment;

	public EntityDreadThrallMinion(World world){
		super(world);
