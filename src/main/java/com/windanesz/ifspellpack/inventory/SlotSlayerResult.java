...
public class SlotSlayerResult extends Slot
{
    ...
    public SlotSlayerResult(EntityPlayer player, IMerchant merchant, InventoryMerchant merchantInventory, int slotIndex, int xPosition, int yPosition)
    {
