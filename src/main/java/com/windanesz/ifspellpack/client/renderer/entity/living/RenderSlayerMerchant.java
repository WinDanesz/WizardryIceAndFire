...
import com.windanesz.ifspellpack.entity.living.EntitySlayerMerchant;
...
public class RenderSlayerMerchant extends RenderBiped<EntitySlayerMerchant> {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntitySlayerMerchant merchant){
		return TEXTURES[0];
	}
