...
public class RenderAbstractSlayerMerchant extends RenderBiped<EntityAbstractSlayerMerchant> {

	static final ResourceLocation[] TEXTURES = new ResourceLocation[6];

	public RenderAbstractSlayerMerchant(RenderManager renderManager){
